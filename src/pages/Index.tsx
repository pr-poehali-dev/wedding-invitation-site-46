...
const WeddingInvitation = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
        className="relative min-h-screen flex items-start justify-center bg-cover bg-center bg-no-repeat pt-8 md:pt-12"
        style={{ 
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 animate-fade-in">
          ...
          <h1 className="text-7xl md:text-9xl font-serif font-light text-primary mb-56 md:mb-64 tracking-wider text-center">Ксения & Владимир</h1>
