    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container max-w-2xl mx-auto px-4">
          <Card className="p-8 md:p-12 bg-white shadow-2xl border-rose-100 overflow-hidden relative">
            ...
            <div className="relative z-10 text-center animate-fade-in">
              <p className="text-xl md:text-2xl font-serif text-primary leading-snug font-light mb-12">
                Дорогие гости!<br/>
      ...
      <footer className="py-16 bg-background border-t border-accent/20">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-muted-foreground font-light tracking-wide">По всем вопросам: +7 (996) 951-90-85
                                 +7 (906) 474-84-50</p>
        </div>
      </footer>
    </div>
